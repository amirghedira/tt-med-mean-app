...
module.exports = ({ doctorPrenom, doctorNom, trimestre, annee, workingHours }) => {
    ...
    let months
    // const presencesOfTheYear = dates.filter(date => new Date(date).getFullYear() == annee)
            ...
            <table class="container-table" cellpadding='0' cellspacing="0">
                <table>
                    <tr>
                        ...
                        <td>
                            <h2 style="font-style: italic;">Note de Présence 1er Trimestre 2021</h2>
                            <h2 style="font-style: italic;">Direction Régionale Des Télécommunications</h2>
                            <h2 class="left" style="font-style: italic;">Dr.............................</h2>
